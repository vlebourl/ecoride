  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center bg-bg px-6">
      ...
      <button
        ...
        className="flex w-full max-w-sm items-center justify-center gap-3 rounded-xl bg-white px-6 py-4 text-sm font-bold text-gray-800 shadow-lg active:scale-95"
      >
