...
export const updateUserSchema = z
  ...
  .refine(
    (data) => {
      if (data.super73AutoModeLowSpeedKmh == null || data.super73AutoModeHighSpeedKmh == null) {
        return true;
      }
      return data.super73AutoModeLowSpeedKmh < data.super73AutoModeHighSpeedKmh;
    },
    {
      message: "super73AutoModeLowSpeedKmh must be lower than super73AutoModeHighSpeedKmh",
